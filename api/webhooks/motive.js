/**
 * Motive Webhook Ingestion Endpoint
 *
...
import { verifyWebhookSignature, normalizeWebhook } from '../telematics/lib/providers/motive.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 2. Find connection
    const vehicleId = payload.data?.vehicle?.id || payload.data?.vehicle_id || null;
    ...
    if (!userId) {
      console.warn('Motive webhook received but no matching connection found');
    ...
    console.error('Motive webhook error:', err);
