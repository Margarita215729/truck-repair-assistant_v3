...
export const PLANS = {
  free: {
    ...
    priceAnnual: 0,
    features: [
      { key: 'ai_requests', value: '5 AI requests/day', valueRu: '5 AI запросов/день' },
      { key: 'trucks', value: '2 trucks', valueRu: '2 грузовика' },
      { key: 'diagnostics', value: 'Basic AI diagnostics', valueRu: 'Базовая AI диагностика' },
  ...
  owner: {
    ...
    features: [
      { key: 'ai_requests', value: 'Unlimited AI requests', valueRu: 'Безлимитные AI запросы' },
      { key: 'trucks', value: 'Up to 5 trucks', valueRu: 'До 5 грузовиков' },
      { key: 'diagnostics', value: 'Advanced AI diagnostics', valueRu: 'Продвинутая AI диагностика' },
